    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          bottom: const TabBar(labelStyle: TextStyle(fontSize: 11), tabs: [
            Tab(text: " Info"),
            Tab(text: "Sports"),
            Tab(text: "Attendence"),
            Tab(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          '${snapshot.data!.data!.personalInfo!.name}')
                                    ],
                                  ),
                                ],
                              ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(snapshot
                                          .data!.data!.personalInfo!.fatherName
                                          .toString())
                                    ],
                                  ),
                                ],
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(snapshot
                                          .data!.data!.personalInfo!.pincode
                                          .toString())
                                    ],
                                  ),
                                ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(snapshot
                                        .data!.data!.sportsInfo!.dateOfJoining
                                        .toString())
                                  ],
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(snapshot.data!.data!.sportsInfo!.sport
                                        .toString())
                                  ],
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(snapshot.data!.data!.sportsInfo!.type
                                        .toString())
                                  ],
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(snapshot.data!.data!.sportsInfo!.batch
                                        .toString())
                                  ],
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(snapshot
                                        .data!.data!.sportsInfo!.speciality
                                        .toString())
                                  ],
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(snapshot
                                        .data!.data!.sportsInfo!.startTime
                                        .toString())
                                  ],
                                ),
                              ],
